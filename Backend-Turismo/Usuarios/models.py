...
class Usuario(AbstractBaseUser):
    ...
    pais = models.CharField ("Pais", blank=True, max_length=200, null=True)
    cuidad = models.CharField ("Ciudad", blank=True, max_length=200, null=True)
    edad = models.CharField ("Edad", blank=True, max_length=10, null=True)
